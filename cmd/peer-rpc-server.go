...
// LoadCredentialsArgs - set credentials RPC arguments.
type LoadCredentialsArgs struct {
	AuthArgs
}

// LoadCredentials - handles load credentials RPC call.
func (receiver *peerRPCReceiver) LoadCredentials(args *LoadCredentialsArgs, reply *VoidReply) error {
